...
<div class="container">
	<div class="row mt-3 ms-1 me-1">
		...
		<br>
		<p class="mt-3">Mari kita bahas satu-persatu.</p>
		<br>
		...
		<br>
		<p class="mt-3">Ternyata, Andi mendapatkan nilai <b>95</b>. Maka, Andi seharusnya mendapatkan kalimat "SANGAT MEMUASKAN" bukan?</p>
		<br>
		...
		<br>
		<h3 class="mt-3"><b>Menggunakan switch dan case</b></h3>
		<br>
		...
		<p class="mt-3">Apabila kita mempunyai dua atau lebih kondisi yang berbeda, tetapi keputusan yang akan dijalankan sama, kita bisa menggabungkan beberapa perintah <b>case</b> tanpa menggunakan <b>break</b> dan hanya menggunakan <b>break</b> di kondisi terakhir.</p>
