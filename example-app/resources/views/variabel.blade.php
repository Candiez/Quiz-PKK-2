...
<div class="container">
	<div class="row mt-3 ms-1 me-1">
		...
		<br>
		<p class="mt-4">Dalam menamakan variabel, kalian pun perlu mengikuti beberapa ketentuan sebagai berikut:</p>
		<br>
		<div>
			<ol>
		...
		<div>
			<div class="py-1 px-1 mt-4" style="background-color: pink;">
		...
		<br>
		<p class="mt-3">Selanjutnya, variabel <b>apakahSudahMenikah</b> bernilai <b>false</b> dengan tipe data boolean.</p>
		<!-- <br> -->
		...
		<br>
		<p class="mt-3">Terakhir, variabel <b>jumlahAnak</b> bernilai undefined, karena memang tidak diisi dengan nilai apapun. Jika variabel tidak kita beri sebuah nilai, secara default (standar) ia memiliki nilai undefined.</p>
		<br>
		<!-- <hr> -->
		...
		<br>
		<h3 class="mt-3"><b>Menampilkan Data di Console</b></h3>
		<br>
